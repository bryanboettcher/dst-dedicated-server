return {
  ...
  custom_settings_id="CUSTOM_GAMING GROUP - CAVES",
  custom_settings_name="Gaming Group - Caves",
  custom_worldgen_desc="",
  custom_worldgen_id="CUSTOM_GAMING GROUP - CAVES",
  custom_worldgen_name="Gaming Group - Caves",
